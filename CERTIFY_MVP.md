...
- Restrição simples: apenas carteiras emissoras autorizadas podem emitir.
...
- Vários administradores com painel completo.
...
NEXT_PUBLIC_ISSUER_WALLETS=COLE_AQUI_A_SUA_WALLET_PUBLICA
