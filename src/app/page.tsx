...
const steps = [
  ...
  [
    "02",
    "Registre",
    "O badge é emitido para a wallet do participante na Devnet.",
  ],
  [
    "03",
    "Verifique",
    "Qualquer pessoa valida a conquista por um link público.",
  ],
];
        ...
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <Link
              ...
              href="/verificar/CERT-7K4M2P"
            >
              Ver exemplo
            </Link>
          </div>
          <p className="hero-note">
            <span>●</span> Construído para a Solana Devnet
          </p>
        </div>

        <div
          className="hero-visual"
          aria-label="Exemplo de certificado Certify"
        >
